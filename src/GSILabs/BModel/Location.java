...
public class Location implements Comparable
{
    ...
    private int capacity;     // the capacity of the location
    private String country;   // the country of the location
    private String province;  // the province of the location
    private String city;      // the city of the location
    private String street;    // the street of the location
    private short number;     // the number of the location
